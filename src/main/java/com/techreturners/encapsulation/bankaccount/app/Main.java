...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //SECURE WEATHER REPORT
        System.out.println("--- SECURE WEATHER REPORT ---\n");
        System.out.println("Mmm...let's make a secure weather report!");
        WeatherReporter myWeatherReport = new WeatherReporter("London", 15);
        System.out.println(myWeatherReport.print());

        myWeatherReport.setLocation("California");
        myWeatherReport.setTemperature(9);
        System.out.println(myWeatherReport.print());

        myWeatherReport.setLocation("Cape Town");
        myWeatherReport.setTemperature(31);
        System.out.println(myWeatherReport.print());
    }
